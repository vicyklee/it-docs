...
### Step No 1
First log into the IT service portal and choose “create ticket” at https://serviceportal.ku.dk/HEAT/Modules/SelfService/#home

### Step No2
Then select **“Errors Reporting and Questions”** from the Service Catalog
Then click **“Request”**
...
Remember to write the name of the machine e.g. **racimocomp04fl** in the **"System name"** box
...
If possible, once you have the ticket, feel free to forward the ticket email to any IT person that has recently contacted you about the server, informing them of the existence of the ticket and the urgency (if there is one).
This can help as sometimes tickets may sit without a response for some time.
If you do, CC Fernando in the mail.

### Step No4
Patiently await the response from KU-IT!
